...
activities = {
    ...
    "Art Club": {
        ...
        "max_participants": 18,
        "participants": ["maya@mergington.edu", "jordan@mergington.edu"]
    },
    "Drama Club": {
        "description": "Rehearse and perform plays, improv, and stagecraft",
        "schedule": "Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 25,
        "participants": ["felicity@mergington.edu", "dan@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science competitions with hands-on experiments",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["noah@mergington.edu", "sarah@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop public speaking and argumentation skills",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["chris@mergington.edu", "emma@mergington.edu"]
    }
}
